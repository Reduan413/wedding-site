...
export const CONFIG = {
  brideFirst: "Priya",
  groomFirst: "Arjun",
  weddingDateISO: "2026-08-29T18:00:00",
  weddingDateDisplay: "29 August 2026",
  place: "Kapasgola, Chittagong",
  hashtag: "#PriyaWedsArjun",

  blessing:
    "\u201CMay this sacred union be blessed with endless joy, unwavering companionship, and a home filled with love and peace. Wishing you both a lifetime of happiness as you begin this beautiful journey together.\u201D",
  ...
  coupleClosing:
    "We are honoured to invite you the Wedding Ceremony of Priya & Arjun as they begin their journey together in faith and love, we thank you for being part of this blessed occation",
  ...
  venue: {
    ...
    mapsUrl: "https://maps.app.goo.gl/G78S6PrVYzDMWsq37",
  },
