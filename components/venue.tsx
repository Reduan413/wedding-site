...
import LocationBg from "@/public/location-bg.png"
...
export function Venue() {
  ...
  return (
    ...
    >
      <Image src={LocationBg} alt="" className="absolute top-0 left-0 w-full h-full z-10" />
      <div className="mx-auto max-w-[920px] z-20 relative">
        <SectionHead label="Join Us At" title="The Venue" />

        <div
          data-reveal
          className="grid overflow-hidden rounded border border-[#ecdfc4]  md:grid-cols-2"
        >
          <div className="flex flex-col justify-center p-[38px]">
            <h3 className="mb-2.5 text-[1.6rem] font-['Cormorant_Garamond',serif] text-[var(--maroon)]">
              {CONFIG.venue.name}
            </h3>
            ...
            <a
              ...
              className="self-start rounded-[2px] bg-[var(--teal)] px-6 py-3 font-[Poppins,sans-serif] text-[0.75rem] uppercase tracking-[0.12em] text-white no-underline transition-colors duration-300 "
            >
              Get Directions
            </a>
          </div>

          <div className="flex  items-center justify-center  text-center text-[var(--maroon)] ">
